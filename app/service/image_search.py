...
async def image_search(query: str, image_num) -> List[(str, str)]:
    ...
    for result in results:
        ...
        all_results.append((result['text'], link))
    return all_results

async def images_search(queries: List[str], image_num: int) -> Dict[str, List[(str, str)]]:
